...
export const iconMap: Record<string, ImagePaths> = {
  ...
  // Example: "BTC": { lightMode: baseImgUrlToken("BTC-lightmode"), darkMode: baseImgUrlToken("BTC-darkmode") },
  
  // Wallet icons will be added here  
  // Example: "MetaMask": { lightMode: baseImgUrlWallet("MetaMask-lightmode"), darkMode: baseImgUrlWallet("MetaMask-darkmode") },
  
  // System icons will be added here
  // Example: "Ethereum": { lightMode: baseImgUrlSystem("Ethereum-lightmode"), darkMode: baseImgUrlSystem("Ethereum-darkmode") },
};
